...
namespace MayaFramework {
    ...
    /// </summary>
    public class MySqlDatabase : PGDatabase {

        /// <summary> Initial MySqlDBSpool with ConnectionString, DefaultTimeout. </summary>
        ...
        public MySqlDatabase( string ConnectionString, int? DefaultTimeout = null, bool DefaultThrowException = false )
            : base( new MySqlProvider(), ConnectionString, DefaultTimeout, DefaultThrowException ) { }
